// To parse this data:
//
//   import { Convert, OrderDetails } from "./file";
//
//   const orderDetails = Convert.toOrderDetails(json);
//
...
export class Convert {
    public static toOrderDetails(json: string): OrderDetails {
        return cast(JSON.parse(json), r("OrderDetails"));
    }

    public static orderDetailsToJson(value: OrderDetails): string {
        return JSON.stringify(uncast(value, r("OrderDetails")), null, 2);
    }
}
