...
const typeMap: any = {
  User: o(
    [
      { json: "id", js: "id", typ: 0 },
      { json: "old_id", js: "old_id", typ: u(undefined, 0) },
      { json: "name", js: "name", typ: "" },
      { json: "email", js: "email", typ: "" },
      { json: "phone", js: "phone", typ: "" },
      { json: "email_verified_at", js: "email_verified_at", typ: u(undefined, Date) },
      { json: "profile_photo_path", js: "profile_photo_path", typ: u(undefined, "") },
